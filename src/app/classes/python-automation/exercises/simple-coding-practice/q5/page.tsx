...
export default function Question5() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto mb-20">
      <div className="mb-8">
        <h1 className="text-3xl font-bold tc1">Question 5 — Placeholder</h1>
      ...
      <div className="bg1 rounded-lg p-8 shadow-sm border border-gray-200 dark:border-gray-800">
        ...
        <p className="tc2 mb-6">This page is a placeholder for Question 5. Instructions and starter code will be added here.</p>
        ...
        <div className="mt-6 flex items-center justify-between gap-4">
          ...
          <NextQuestion assignmentPath={assignmentPath} prevHref="/classes/python-automation/exercises/simple-coding-practice/q4" nextHref="/classes/python-automation/exercises/simple-coding-practice/q6" />
        </div>
      </div>
    </div>
  );
