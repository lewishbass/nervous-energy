...
export default function Question7() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto mb-20">
      <div className="mb-8">
        <h1 className="text-3xl font-bold tc1">Question 7 — Placeholder</h1>
      ...
      <div className="bg1 rounded-lg p-8 shadow-sm border border-gray-200 dark:border-gray-800">
        ...
        <p className="tc2 mb-6">This page is a placeholder for Question 7. Instructions and starter code will be added here.</p>
