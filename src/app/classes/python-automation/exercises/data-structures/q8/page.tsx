  ...
  return (
    <>
      ...
      <div className="p-6 max-w-4xl mx-auto backdrop-blur bg-white/20 dark:bg-black/20 min-h-[100vh]">
        <AssignmentOverview
          title="Q8 - Review"
          description="Apply all data structure concepts learned to solve a multi-part problem."
          objectives={[
            'Choose the right data structure for a given problem',
            'Combine multiple data structures to solve a complex task',
            'Demonstrate understanding of time and space trade-offs',
            'Implement a complete solution from scratch',
          ]}
        />
        ...
        <div className="mt-6 flex items-center justify-between gap-4">
          ...
          <NextQuestion assignmentPath={assignmentPath} nextHref={undefined} prevHref="q7" />
        </div>
      </div>
    </>
  );
