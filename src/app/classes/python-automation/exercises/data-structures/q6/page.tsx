  ...
  return (
    <>
      ...
      <div className="p-6 max-w-4xl mx-auto backdrop-blur bg-white/20 dark:bg-black/20 min-h-[100vh]">
        <AssignmentOverview
          title="Q6 - Heap Sort"
          description="Build a heap and use it to sort data efficiently."
          objectives={[
            'Understand the heap property (min-heap and max-heap)',
            'Build a heap from an unsorted list',
            'Implement heapify and extract operations',
            'Use heap sort to sort an array in place',
          ]}
        />
        ...
        <div className="mt-6 flex items-center justify-between gap-4">
          ...
          <NextQuestion assignmentPath={assignmentPath} nextHref="q7" prevHref="q5" />
        </div>
      </div>
    </>
  );
