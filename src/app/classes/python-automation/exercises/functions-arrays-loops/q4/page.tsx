  ...
  return (
    <>
      ...
      <div className="p-6 max-w-4xl mx-auto backdrop-blur bg-white/20 dark:bg-black/20 min-h-[100vh]">
        <AssignmentOverview
          title="Q4 - For Loops"
          description="Iterate over a fixed range using for loops, control loop flow."
          objectives={[]}
        />
        ...
        <div className="mt-6 flex items-center justify-between gap-4">
          ...
          <NextQuestion assignmentPath={assignmentPath} nextHref="/classes/python-automation/exercises/functions-arrays-loops/q5" />
        </div>
      </div>
    </>
  );
