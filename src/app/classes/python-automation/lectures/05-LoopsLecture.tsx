...
function LoopsLecture(props: LoopsLectureProps | null) {
...
function LoopsLectureIcon(props: LoopsLectureIconProps | null) {
	const { displayMode = 'card', className = '', style, onClick } = props || {};
  return (
    <LectureIcon title="Loops and Iteration" summary="Master repetitive tasks with loops." displayMode={displayMode} className={className} style={style} onClick={onClick} />
  );
}

export { LoopsLecture, LoopsLectureIcon };
