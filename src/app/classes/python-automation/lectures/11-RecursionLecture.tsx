...
function RecursionLectureIcon(props: RecursionLectureIconProps | null) {
  ...
  return (
    <LectureIcon title="Recursion ( Canceled for Weather )" summary="Understand and implement recursive functions in Python." displayMode={displayMode} className={className} style={style} onClick={onClick} />
  );
}
