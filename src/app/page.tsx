	...
	return (
		<div className="w-full">
			...
			<section className="min-h-screen relative p-6 bg3 tc1 overflow-hidden select-none snap-start">
				...
				/>
				<div className="absolute top-3 left-1/2 transform -translate-x-1/2 text-center text-xl tc2 w-full opacity-50 flex flex-row justify-center">
					<div className="w-full sm:w-[600px] md:w-[800px] lg:w-[1000px] xl:w-[1200px] px-4">
						This website is a work in progress please use the
						<a href="https://github.com/lewishbass/nervous-energy/issues/new" target="_black" className="mx-2 tc1 font-semibold cursor-pointer hover:underline">
							Report Issue
						</a>
				...
				<DragCard className="top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[500] bg-white dark:bg-black p-6 rounded-3xl relative overflow-hidden">
					...
					<table className="w-full text-xl">
						<thead>
							<tr>
								<th className="text-left font-bold w-0"></th>
								<th className="text-left font-bold"></th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td className="font-bold text-right">LLMs:&nbsp;</td>
								<td><a href="https://app.netlify.com/projects/llm-tutor/overview" target="_blank" rel="noopener noreferrer" className="text-blue-700 dark:text-blue-300" >teaching</a> and context compression</td>
							</tr>
							<tr>
								<td className="font-bold text-right">VR:&nbsp;</td>
								<td><a href="https://github.com/lewishbass/VR" target="_blank" rel="noopener noreferrer" className="text-blue-700 dark:text-blue-300" >engine</a> and game dev</td>
							</tr>
							<tr>
								<td className="font-bold text-right">Drones:&nbsp;</td>
								<td>design and FPV flying</td>
							</tr>
							{/*<tr>
								<td className="font-bold text-right">Games:&nbsp;</td>
								<td>Description</td>
							</tr>*/}
							<tr>
								<td className="font-bold text-right">Teaching:&nbsp;</td>
								<td>tutoring and <a href="https://lewisbass.org/classes/python-automation" target="_blank" rel="noopener noreferrer" className="text-blue-700 dark:text-blue-300" >computer science</a> </td>
							</tr>
						</tbody>
					</table>
				</DragCard>
						...
						<tbody>
							<tr >
								<th colSpan={3} className="text-left">
									<h3 className="text-2xl font-bold ml-10 mt-2">Machine Learning</h3>
								</th>
							</tr>
							<tr className="text-xl">
								<th className="font-normal px-1"><span className="wg flex items-center nowrap"><SiTensorflow className="text-2xl text-orange-500 mr-1" />Tensorflow</span></th>
								<th className="font-normal px-1"><span className="wg flex items-center nowrap"><SiKeras className="text-2xl text-blue-600 mr-1" />Keras</span></th>
								<th className="font-normal px-1"><span className="wg flex items-center nowrap"><SiPytorch className="text-2xl text-red-600 mr-1" />PyTorch</span></th>
							</tr>
							<tr>
								<th colSpan={3} className="text-left">
									<h3 className="text-2xl font-bold ml-10 mt-2">Web</h3>
								</th>
							</tr>
							...
							<tr>
								<th colSpan={3} className="text-left">
									<h3 className="text-2xl font-bold ml-10 mt-2">Design</h3>
								</th>
							</tr>

							<tr className="text-xl">
								<th className="font-normal px-1"><span className="wg flex items-center nowrap"><SiBlender className="text-2xl text-orange-500 mr-1" /> Blender</span></th>
								<th className="font-normal px-1"><span className="wg flex items-center nowrap"><SiOpengl className="text-2xl text-red-500 mr-1" /> OpenGL</span></th>
								<th className="font-normal px-1"><span className="wg flex items-center nowrap"><SiLatex className="text-2xl text-blue-500 mr-1" /> LaTeX</span></th>
							</tr>
							<tr>
								<th colSpan={3} className="text-left">
									<h3 className="text-2xl font-bold ml-10 mt-2">Development</h3>
								</th>
							</tr>
							<tr className="text-xl">
								<th className="font-normal px-1"><span className="wg flex items-center nowrap"><SiPython className="text-2xl text-yellow-500 mr-1" /> Python</span></th>
								<th className="font-normal px-1"><span className="wg flex items-center nowrap"><SiCplusplus className="text-2xl text-blue-500 mr-1" /> C++</span></th>
								<th className="font-normal px-1"><span className="wg flex items-center nowrap"><SiDocker className="text-2xl text-blue-500 mr-1 " /> Docker</span></th>
							</tr>
						</tbody>
					</table>
				</DragCard>
				...
				<DragCard className="top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[500px] bg1 p-6 rounded-3xl">
					<h2 className="text-4xl font-bold mb-2 ml-10">Hello!</h2>
					<p className="text-xl  w-auto max-w-[100%]">My name is Lewis Bass.</p>
					<p className="text-xl leading-relaxed w-auto w-auto">I&#39;m a recent Masters Graduate from Virginia Tech specializing in</p>
					...
					<p className="text-xl leading-relaxed w-auto max-w-[100%]">
						research, including: Drug Discovery, Computer Vision, and LLM context compression.
					</p>
				</DragCard>
